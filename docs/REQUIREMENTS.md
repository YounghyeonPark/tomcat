...
| NFR10 | **Disturbance rejection envelope** (trot)         | **≥ 68 mm** DCM error — 33 mm from foot placement + 24 mm from the LATERAL SPINE (ADR-0014). ~~74 mm~~ overstated 2.3× in ADR-0013 by using un-projected fore-aft reach. |
